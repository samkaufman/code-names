...
final public class OldSubtokenizer {
    ...
    public static List<String> subtokenize(String token) {
        ...
        assert consumedAll : "entire token \"" + token + "\"was not consumed; subtokens were " + subtokens.toString();
        return subtokens;
    }
}
